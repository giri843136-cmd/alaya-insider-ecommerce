...
function seedCommsData() {
  ...
  const templates: NotificationTemplate[] = [
    ...
    { id: "tpl_abandoned", name: "Abandoned Cart", category: "marketing", channels: ["email", "push"], subject: "You left something behind!", body: "Hi {{name}}, your cart is waiting. Complete your purchase now!", variables: ["name", "cart_url"], version: "1.1", status: "draft", usageCount: 0, createdAt: now - 30 * 86400000, updatedAt: now - 2 * 86400000 },
