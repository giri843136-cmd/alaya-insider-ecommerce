...
| Domain | Modules |
|--------|---------|
| **Commerce** | Products, categories, brands, orders, cart, checkout, coupons, returns, suppliers, gateways, **Supplier Automation** (full dropshipping engine) |
...
| TypeScript errors | **0** |
| Build size | 3,235 KB (724 KB gzip) |
