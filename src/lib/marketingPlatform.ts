...
function seedMarketingData() {
  ...
  const emailCampaigns: EmailCampaign[] = [
    ...
    { id: uid("ec"), campaignId: campaigns[3].id, name: "Cart Recovery Email", subject: "You left something behind", preheader: "Your cart is waiting with a special offer",        bodyHtml: "<h1>Your cart is waiting</h1><p>Compare the best prices and see the latest deals from trusted merchants.</p>",
        bodyText: "Your cart is waiting. Compare prices from trusted merchants and find the best deal.", senderName: "ALAYA INSIDER", senderEmail: "orders@alayainsider.com", replyTo: "orders@alayainsider.com", version: 1, status: "ready", createdAt: now - 86400000 * 10, updatedAt: now - 86400000 * 2 },
  ];
